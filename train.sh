...
# rm -rf ./ckpt/vqvae400/*
python3 train.py config/default.yaml > ./logs/soft/soft1.log
...
# python3 generate.py config/test.yaml ./ckpt/vqvae10/params/step_1170-RC_2.458-VQ_0.073-model.pt generations/123vqvae10/ 10 5 